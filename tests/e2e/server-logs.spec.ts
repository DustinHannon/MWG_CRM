...
/**
 * Phase 27 §7 — Phase 26 §5 deferred /admin/server-logs spec.
 *
 ...
 *   - /admin/server-logs returns 200 for admin.
 ...
 *     filter pre-fills.
 *   - phase26-final-server-logs.png visual parity.
 *
 * Manual setup needed before un-skipping:
 *   - PLAYWRIGHT_BETTERSTACK_FIXTURE_TOKEN env var.
 *   - Seed script .tmp/seed-server-logs.ts emitting 50 known events
 *     across 3 severities + 2 request-ids.
 */
test.describe.skip("Phase 26 §5 — /admin/server-logs (deferred — needs Better Stack fixture)", () => {
