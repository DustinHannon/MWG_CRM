...
export function BulkActionToolbar({ children }: { children?: ReactNode }) {
  ...
  return (
    <div
      ...
      className="pointer-events-none fixed inset-x-2 bottom-[max(1rem,env(safe-area-inset-bottom))] z-20 flex justify-center md:inset-x-0"
    >
      <div className="pointer-events-auto flex w-full max-w-3xl flex-wrap items-center gap-2 rounded-lg border border-border bg-popover px-3 py-2 text-sm text-popover-foreground shadow-lg">
        ...
        <div className="ml-auto flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="inline-flex h-7 items-center gap-1 rounded-md border border-border bg-background px-2 text-xs text-foreground transition-colors hover:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
