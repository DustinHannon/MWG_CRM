  ...
  return (
    <div className="px-10 py-10">
      ...
      <GlassCard className="mt-8 p-6">
        ...
        <div className="mt-4 overflow-x-auto">
          <table className="w-full text-xs">
            <thead className="text-[10px] uppercase tracking-wide text-white/50">
              <tr>
            ...
            <tbody className="divide-y divide-white/5 text-white/80">
              {TEMPLATE_HEADERS.map((h) => (
                <tr key={h.field}>
                  ...
                  <td className="px-3 py-1.5 text-white/65">{h.notes ?? ""}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      <GlassCard className="mt-6 p-6">
        ...
        <pre className="mt-3 overflow-x-auto rounded-md border border-white/10 bg-black/30 p-3 text-[11px] leading-relaxed text-white/80">{`[2026-01-29 02:54 PM UTC] Dental Quote
  ...
  Outgoing | Left Voicemail | By: Tanzania Griffith`}</pre>
              ...
              <tbody className="divide-y divide-white/5 text-white/80">
                {[
                  ...
                  <tr key={from}>
                    ...
                    <td className="py-1 pr-3 text-white/40">→</td>
      ...
      <GlassCard className="mt-6 p-6">
        ...
        <ul className="mt-3 space-y-1 text-xs text-white/80">
          ...
          <li>
            <span className="text-white/50">Opportunity stage: </span>
      ...
      <GlassCard className="mt-6 p-6">
        ...
        <ul className="mt-3 list-disc pl-6 text-sm text-white/70">
          <li>
            <span className="font-medium text-white/85">External ID</span> is
