          ...
          SELECT
            (SELECT count(*)::int FROM leads
             WHERE is_deleted = false
               AND status IN ('new','open','attempting_contact','contacted','scheduled_follow_up','recapture_termed','qualified')
        ...
        canViewAll
          ? db.execute<OwnerRow>(sql`
              ...
              WHERE l.is_deleted = false
                AND l.status IN ('new','open','attempting_contact','contacted','scheduled_follow_up','recapture_termed','qualified')
